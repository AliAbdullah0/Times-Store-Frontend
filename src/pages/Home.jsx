        ...
        <div class="container mx-auto px-6 flex relative">
            <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                ...
                <div class="flex mt-8">
                    ...
                    <a href="/contact" class="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-pink-500 text-pink-500 dark:text-white hover:bg-pink-500 hover:text-white sm:text-md text-sm">
                        Contact
                    </a>
                </div>
            </div>
