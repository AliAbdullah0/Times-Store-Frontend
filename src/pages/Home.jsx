...
function Home() {
  return (
    <main class="dark:bg-gray-800 bg-white relative overflow-x-hidden space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
        <div class="container mx-auto px-6 flex relative">
            <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                ...
                <div class="flex mt-8">
                    <a href="/profile" class="uppercase py-2 px-4 rounded-lg bg-pink-500 border-2 border-transparent text-white sm:text-md text-sm mr-4 hover:bg-pink-400">
                        Get started
                    </a>
