...
function Error() {
  return (
    <div class="bg-black h-screen flex items-center justify-center  bg-grid-small-white/[0.2]">
    <div class="p-8 bg-gray-100 rounded-lg shadow-lg max-w-md w-full">
        ...
        <Link to="/" class="inline-block py-3 px-6 bg-black text-white rounded-lg font-semibold">Go
