...
function ProductCard({ product }) {
  ...
  return (
    <div className="flex flex-col md:w-[23%] w-10/12 justify-between bg-black ml-2 mr-2 hover:scale-[1.03] hover:transition-all hover:shadow-2xl drop-shadow-xl rounded-md p-3">
