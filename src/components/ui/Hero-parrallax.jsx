...
export const Header = () => {
    return (
      <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
        <h1 className="text-2xl md:text-7xl font-extrabold text-white">
         <TextGenerateEffect words={'ZENTIME'} duration={0.5} className={'text-4xl md:text-7xl font-black text-white'}/><TextGenerateEffect className={'text-4xl md:text-7xl font-black text-white'} words={'WATCHES'}/> 
        </h1>
        ...
        <button><Link to={'/profile'} className="p-2 bg-white text-black mt-2 hover:bg-black hover:text-white hover:transition-all">Get Started</Link></button>
        </p>
      </div>
    );
  };
